...
export const metadata: Metadata = {
  title: "Generate Sequence (Beta) | Sequence",
  description: "Try our enhanced sequence generator to create customized yoga sequences based on your preferences",
}

export default function BetaGeneratorPage() {
  return (
